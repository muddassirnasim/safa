...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|70","left":"1rem","right":"1rem"}}},"layout":{"type":"constrained","justifyContent":"center","contentSize":"700px"}} -->
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--60);padding-right:1rem;padding-bottom:var(--wp--preset--spacing--70);padding-left:1rem"><!-- wp:navigation {"overlayMenu":"never","icon":"menu","style":{"spacing":{"blockGap":"var:preset|spacing|50"}},"layout":{"type":"flex","justifyContent":"center"}} -->
...
<ul class="wp-block-social-links has-normal-icon-size is-style-logos-only"><!-- wp:social-link {"url":"https://www.facebook.com/","service":"facebook"} /-->
